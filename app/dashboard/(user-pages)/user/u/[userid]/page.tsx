...
export default function Page() {
    ...
    const [teamcreatedData,setTeamCreatedData] = useState<teamCreatedData[]>()
            ...
            (
                ...
                <div className='flex flex-col gap-y-3 text-xs'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <LeadersTeams teamcreatedData={teamcreatedData} userid={userid} />
...
function LeadersTeams({teamcreatedData,userid}:{teamcreatedData:teamCreatedData[] | undefined,userid:string | string[] | undefined}){
    const {user} = useUser()
                ...
                <SelectGroup className='text-[9px]'>
                    {
                        ...
                        :
                        <SelectItem className='text-[12px]' value={'null'}>No teams there!</SelectItem>
                    }
                </SelectGroup>
                </SelectContent>
            </Select>
