...
type teamCreatedAttributeNamenType = {
   attribute : string;
   className:string;
}
      ...
      <div className='flex flex-col gap-y-1 text-xs'>
        <p className='font-medium py-3'>
          ...
          <span className='text-xl capitalize '>
            {fetchinguserdata ? <Skeleton className='rounded w-20 h-5' /> : 
              <>
        ...
        <div className="overflow-x-auto scrollbar-hide py-1 pb-2 w-full ">
          <div className='flex items-center justify-between font-opensans py-1 rounded-md min-w-[600px]'>
            {
